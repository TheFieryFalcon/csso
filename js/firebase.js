...
import { 
    getFirestore, collection, doc, setDoc, getDoc, updateDoc, deleteField, onSnapshot, 
    serverTimestamp 
...
export {
    signInWithPopup, GoogleAuthProvider, signOut, doc, setDoc, getDoc, updateDoc, deleteField, serverTimestamp
};
